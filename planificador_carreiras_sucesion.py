...
if __name__ == "__main__":
    perfil_empleado = (
        "Empleado: Adrián Fernández. Cargo: Desarrollador Senior Backend. 15 años de experiencia en desarrollo de software. "
        "Habilidades: Java, .NET, Python, AWS, Cloud Store, SQL, Liderazgo de equipos pequeños (3 personas). "
        "Aspiración: CTO o Director de Ingeniería."
    )
